-- Security improvements: Fix function search paths and restrict profiles access
...
-- Restrict profiles access to authenticated users only
...
-- Ensure users can only delete their own profiles when account is deleted
